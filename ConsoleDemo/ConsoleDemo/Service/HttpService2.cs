...
namespace ConsoleDemo.Service
{
    ...
    public class HttpService2
    {
        ...
        /// 日志实例
        /// </summary>
        private static readonly ILog log = LogManager.GetLogger(typeof(HttpService2));
        ...
        /// plain头
        /// </summary>
        public static readonly string plainHeader = "HTTP/1.0 200 OK\nContent-Type: text/plain;charset=utf-8\nConnection: close\n\n";
        /// <summary>
        /// html头
        /// </summary>
        ...
        /// png头byte[]
        /// </summary>
        public static readonly byte[] pngHeaderBytes = Encoding.UTF8.GetBytes("HTTP/1.0 200 OK\nContent-Type: image/png\nConnection: close\n\n");
        /// <summary>
        /// jpg头byte[]
        /// </summary>
        public static readonly byte[] jpgHeaderBytes = Encoding.UTF8.GetBytes("HTTP/1.0 200 OK\nContent-Type: image/jpeg\nConnection: close\n\n");
        ...
        public bool Start(IPAddress ip, int port, Action serviceCloseCallback, Func<string, NameValueCollection, byte[]> responseCallback)
        {
            try
            {
                // 新建服务器
